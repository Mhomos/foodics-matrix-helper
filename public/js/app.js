...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getMappedMatrices: function getMappedMatrices() {
      return this.matrices.map(function (item) {
        return item.values.map(function (rows) {
          return rows.map(function (number) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "card card-default" }, [
      _c("div", { staticClass: "card-header" }, [_vm._v("Matrix Helper")]),
      _vm._v(" "),
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.matrices_number,
                    expression: "matrices_number"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "number", id: "matrices", required: "" },
                domProps: { value: _vm.matrices_number },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.matrices_number = $event.target.value
                  }
                }
              })
            ]),
      ...
      _c("div", { staticClass: "card-body" }, [
        _vm.has_error
          ? _c("div", { staticClass: "alert alert-danger" }, [
              _c("p", [_vm._v("Login to use the panel")])
            ])
          : _vm._e(),
        _vm._v(" "),
        _c(
...
/* harmony import */ var _Index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Index */ "./resources/js/Index.vue");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.router = _router__WEBPACK_IMPORTED_MODULE_5__["default"];
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // require("./bootstrap");

vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('index', _Index__WEBPACK_IMPORTED_MODULE_4__["default"]);
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: "#app",
  components: {
    Login: _pages_Login__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
...
__webpack_require__(/*! /var/www/matrix-helper.localhost/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/matrix-helper.localhost/resources/sass/app.scss */"./resources/sass/app.scss");
